...
class diff_renderer
{
    ...
    * Constructor.
    */
    public function diff_renderer($params = array())
    {
    ...
    */
    public function get_diff_content($diff)
    {
...
class diff_renderer_inline extends diff_renderer
{
    ...
    public $_ins_prefix = '<span class="ins">';
    public $_ins_suffix = '</span>';

    // Prefix and suffix for deleted text
    public $_del_prefix = '<span class="del">';
    public $_del_suffix = '</span>';
    ...
    */
    ...
    public function _split_on_words($string, $newline_escape = "\n")
    {
...
';
    ...
    public function _perform_add($line)
    {
        if ($this->state == 'empty') {
            return '';
        }
    ...
    public function _perform_delete($line)
    {
    ...
    public function _perform_context($line)
    {
