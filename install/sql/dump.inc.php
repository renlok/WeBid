...
$query[] = "INSERT INTO `" . $DBPrefix . "settings` VALUES ('errortext', 'str', 'An unexpected error occurred. The error has been forwarded to our technical team and will be fixed shortly', UNIX_TIMESTAMP(), 1);";
