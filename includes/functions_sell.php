...
function setvars()
{
	...
	$sdescription = (isset($_POST['sdescription'])) ? $system->cleanvars($_POST['sdescription'], array('safe' => 1,'elements'=>'a ol ul li u strong em br', 'deny_attribute'=>'*')) : $_SESSION['SELL_description'];
