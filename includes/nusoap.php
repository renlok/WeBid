...
* @version  $Id: nusoap.php,v 1.1 2007/01/15 11:46:36 giancvs Exp $
* @access   public
*/
class nusoap_base {
	...
	*/
	function register($name,$in=false,$out=false,$namespace=false,$soapaction=false,$style=false,$use=false,$documentation=''){
		...
		if(false == $soapaction) {
			...
			$SCRIPT_NAME = isset($_SERVER['PHP_SELF']) ? $_SERVER['PHP_SELF'] : $GLOBALS['SCRIPT_NAME'];
...
/**
*
* soapclientt higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $soapclientt = new soapclientt( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $soapclientt->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapclientt);
*
...
* @access   public
*/
class soapclientt extends nusoap_base  {
	...
	*/
	function getProxy(){
		...
		$r = rand();
		$evalStr = 'class soap_proxy_'.$r.' extends soapclientt {
				'.$evalStr.'
			}';
