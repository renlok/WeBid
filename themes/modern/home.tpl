			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="featured-item">
					<div class="item-ads-grid">
						<div class="img-grid">
							<div class="item-meta">
								<a href="{SITEURL}item.php?id={featured.ID}"><img class="img-hover img-center" style="height: 175px;" src="{featured.IMAGE}"></a>
			...
			<div class="col-md-4 col-sm-4 col-xs-12">
				<div class="featured-item">
					<div class="item-ads-grid">
						<div class="img-grid">
							<div class="item-meta">
								<a href="{SITEURL}item.php?id={hotitems.ID}"><img class="img-hover img-center" style="height: 175px;" src="{hotitems.IMAGE}"></a>
