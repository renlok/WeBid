...
class UserIps
{
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="creeated_at", type="datetime", nullable=false)
     */
    private $creeatedAt = 'CURRENT_TIMESTAMP';
     ...
     * @return DateTime
     */
    public function getCreeatedAt()
    {
        return $this->creeatedAt;
    }

    /**
     * @param DateTime $creeatedAt
     */
    public function setCreeatedAt($creeatedAt)
    {
