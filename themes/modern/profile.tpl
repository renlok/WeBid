...
<!-- ENDIF -->
			...
			<div class="col-md-6">
				<h4><span style="margin-right: 10px;" class="glyphicon glyphicon-user" aria-hidden="true"></span>{USER} ({SUM_FB}) <img src="{SITEURL}images/icons/{FB_ICON}" alt="{FB_ICON}" class="fbstar"></h4><br>
