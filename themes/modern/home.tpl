                ...
                <div class="item-ads-grid">
                  <div class="img-grid">
                    <div class="item-meta">
                      ...
                      <div class="grid-margin-btm-lg"><small><span class="text-muted"><span class="glyphicon glyphicon-time" aria-hidden="true"></span>  {featured.ENDS}</span></small></div>
                    </div>
                     <div class="bid-price"><span class="pull-left"><h4>{featured.BID}</h4></span>
                ...
                <div class="item-ads-grid">
                  <div class="img-grid">
                    <div class="item-meta">
                       ...
                       <div class="grid-margin-btm-lg"><small><span class="text-muted"><span class="glyphicon glyphicon-time" aria-hidden="true"></span>  {hotitems.ENDS}</span></small></div>
                    </div>
                       <div class="bid-price"><span class="pull-left"><h4>{hotitems.BID}</h4></span>
