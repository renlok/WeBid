...
<!-- BEGIN topay -->
		<tr>
			...
			<td style="text-align: center;">
				<!-- IF topay.PAID --><span class="label label-success">{L_898}</span><br><br><!-- ENDIF --><a class="btn btn-default btn-xs" href="{SITEURL}order_print.php?id={topay.INVOICE}" tagret="_blank">{L_1058}</a>
			</td>
		</tr>
<!-- END topay -->
	</table>
