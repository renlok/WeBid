...
if ($_GET['cats'] == 1)
{
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(0, -1, 1, 390, 'All', 0, 0, '', '', -1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 2, 55, 'Art &amp; Antiques', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 7, 8, 'Ancient World', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 5, 6, 'Amateur Art', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 13, 32, 'Ceramics &amp; Glass', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 4, 14, 31, 'Glass', 0, 0, '', '', 2);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 15, 16, '40s, 50s &amp; 60s', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 17, 18, 'Art Glass', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 19, 20, 'Carnival', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 25, 26, 'Contemporary Glass', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 29, 30, 'Porcelain', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 21, 22, 'Chalkware', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 23, 24, 'Chintz &amp; Shelley', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 5, 27, 28, 'Decorative', 0, 0, '', '', 3);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 33, 34, 'Fine Art', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 35, 36, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 41, 42, 'Painting', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 43, 44, 'Photographic Images', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 49, 50, 'Prints', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 9, 10, 'Books &amp; Manuscripts', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 11, 12, 'Cameras', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 37, 38, 'Musical Instruments', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 39, 40, 'Orientalia', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 45, 46, 'Post-1900', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 47, 48, 'Pre-1900', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 51, 52, 'Scientific Instruments', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 1, 53, 54, 'Silver &amp; Silver Plate', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 3, 4, 'Textiles &amp; Linens', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 56, 133, 'Books', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 59, 60, 'Arts, Architecture &amp; Photography', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 61, 62, 'Audiobooks', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 63, 64, 'Biographies &amp; Memoirs', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 65, 66, 'Business &amp; Investing', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 71, 72, 'Computers &amp; Internet', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 75, 76, 'Cooking, Food &amp; Wine', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 77, 78, 'Entertainment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 79, 80, 'Foreign Language Instruction', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 81, 82, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 83, 84, 'Health, Mind &amp; Body', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 87, 88, 'History', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 89, 90, 'Home &amp; Garden', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 91, 92, 'Horror', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 95, 96, 'Literature &amp; Fiction', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 57, 58, 'Animals', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 67, 68, 'Catalogs', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 69, 70, 'Children', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 93, 94, 'Illustrated', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 97, 98, 'Men', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 101, 102, 'News', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 121, 122, 'Sports', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 131, 132, 'Women', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 99, 100, 'Mystery &amp; Thrillers', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 103, 104, 'Nonfiction', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 105, 106, 'Parenting &amp; Families', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 107, 108, 'Poetry', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 109, 110, 'Rare', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 111, 112, 'Reference', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 115, 116, 'Religion &amp; Spirituality', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 73, 74, 'Contemporary', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 85, 86, 'Historical', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 113, 114, 'Regency', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 117, 118, 'Science &amp; Nature', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 119, 120, 'Science Fiction &amp; Fantasy', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 123, 124, 'Sports &amp; Outdoors', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 125, 126, 'Teens', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 127, 128, 'Textbooks', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 28, 129, 130, 'Travel', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 134, 141, 'Clothing &amp; Accessories', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 69, 135, 136, 'Accessories', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 69, 137, 138, 'Clothing', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 69, 139, 140, 'Watches', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 142, 147, 'Coins &amp; Stamps', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 73, 143, 144, 'Coins', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 73, 145, 146, 'Philately', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 148, 223, 'Collectibles', 1, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 149, 150, 'Advertising', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 151, 152, 'Animals', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 153, 154, 'Animation', 1, 1, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 155, 156, 'Antique Reproductions', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 157, 158, 'Autographs', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 159, 160, 'Barber Shop', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 161, 162, 'Bears', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 163, 164, 'Bells', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 165, 166, 'Bottles &amp; Cans', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 167, 168, 'Breweriana', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 169, 170, 'Cars &amp; Motorcycles', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 171, 172, 'Cereal Boxes &amp; Premiums', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 173, 174, 'Character', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 175, 176, 'Circus &amp; Carnival', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 177, 178, 'Collector Plates', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 179, 180, 'Dolls', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 181, 182, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 183, 184, 'Historical &amp; Cultural', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 185, 186, 'Holiday &amp; Seasonal', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 187, 188, 'Household Items', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 189, 190, 'Kitsch', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 191, 192, 'Knives &amp; Swords', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 193, 194, 'Lunchboxes', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 195, 196, 'Magic &amp; Novelty Items', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 197, 198, 'Memorabilia', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 199, 200, 'Militaria', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 201, 202, 'Music Boxes', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 203, 204, 'Oddities', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 205, 206, 'Paper', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 207, 208, 'Pinbacks', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 209, 210, 'Porcelain Figurines', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 211, 212, 'Railroadiana', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 213, 214, 'Religious', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 215, 216, 'Rocks, Minerals &amp; Fossils', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 217, 218, 'Scientific Instruments', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 219, 220, 'Textiles', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 76, 221, 222, 'Tobacciana', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 224, 241, 'Comics, Cards &amp; Science Fiction', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 225, 226, 'Anime &amp; Manga', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 227, 228, 'Comic Books', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 229, 230, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 231, 232, 'Godzilla', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 233, 234, 'Star Trek', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 235, 236, 'The X-Files', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 237, 238, 'Toys', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 114, 239, 240, 'Trading Cards', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 242, 251, 'Computers &amp; Software', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 123, 243, 244, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 123, 245, 246, 'Hardware', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 123, 247, 248, 'Internet Services', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 123, 249, 250, 'Software', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 252, 263, 'Electronics &amp; Photography', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 128, 253, 254, 'Consumer Electronics', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 128, 255, 256, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 128, 257, 258, 'Photo Equipment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 128, 259, 260, 'Recording Equipment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 128, 261, 262, 'Video Equipment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 264, 283, 'Home &amp; Garden', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 265, 266, 'Baby Items', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 267, 268, 'Crafts', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 269, 270, 'Furniture', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 271, 272, 'Garden', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 273, 274, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 275, 276, 'Household Items', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 277, 278, 'Pet Supplies', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 279, 280, 'Tools &amp; Hardware', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 149, 281, 282, 'Weddings', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 284, 293, 'Movies &amp; Video', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 159, 285, 286, 'DVD', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 159, 287, 288, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 159, 289, 290, 'Laser Discs', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 159, 291, 292, 'VHS', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 294, 307, 'Music', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 164, 295, 296, 'CDs', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 164, 297, 298, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 164, 299, 300, 'Instruments', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 164, 301, 302, 'Memorabilia', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 164, 303, 304, 'Records', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 164, 305, 306, 'Tapes', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 308, 317, 'Office &amp; Business', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 171, 309, 310, 'Briefcases', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 171, 311, 312, 'Fax Machines', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 171, 313, 314, 'General Equipment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 171, 315, 316, 'Pagers', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 318, 333, 'Other Goods &amp; Services', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 319, 320, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 321, 322, 'Metaphysical', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 323, 324, 'Property', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 325, 326, 'Services', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 327, 328, 'Tickets &amp; Events', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 329, 330, 'Transportation', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 176, 331, 332, 'Travel', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 334, 341, 'Sports &amp; Recreation', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 184, 335, 336, 'Apparel &amp; Equipment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 184, 337, 338, 'Exercise Equipment', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 184, 339, 340, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 0, 342, 389, 'Toys &amp; Games', 0, 0, '', '', 0);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 343, 344, 'Action Figures', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 345, 346, 'Beanie Babies &amp; Beanbag Toys', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 347, 348, 'Diecast', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 349, 350, 'Fast Food', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 351, 352, 'Fisher-Price', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 353, 354, 'Furby', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 355, 356, 'Games', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 357, 358, 'General', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 359, 360, 'Giga Pet &amp; Tamagotchi', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 361, 362, 'Hobbies', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 363, 364, 'Marbles', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 365, 366, 'My Little Pony', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 367, 368, 'Peanuts Gang', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 369, 370, 'Pez', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 371, 372, 'Plastic Models', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 373, 374, 'Plush Toys', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 375, 376, 'Puzzles', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 377, 378, 'Slot Cars', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 379, 380, 'Teletubbies', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 381, 382, 'Toy Soldiers', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 385, 386, 'Vintage Tin', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 387, 388, 'Vintage Vehicles', 0, 0, '', '', 1);";
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(NULL, 188, 383, 384, 'Vintage', 0, 0, '', '', 1);";
}
else
{
	$query[] = "INSERT INTO `" . $DBPrefix . "categories` VALUES(0, -1, 1, 2, 'All', 0, 0, '', '', -1);";
}
