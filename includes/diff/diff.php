...
class diff
{
    ...
    */
    public function diff(&$from_content, &$to_content, $preserve_cr = true)
    {
    ...
    */
    public function count_added_lines()
    {
        $count = 0;
    ...
    */
    public function count_deleted_lines()
    {
        $count = 0;
    ...
    */
    public function trim_newlines(&$line, $key)
    {
...
class mapped_diff extends diff
{
    ...
    */
    public function mapped_diff(&$from_lines, &$to_lines, &$mapped_from_lines, &$mapped_to_lines)
    {
...
{
    public function diff_op_copy($orig, $final = false)
    {
        if (!is_array($final)) {
            $final = $orig;
        }
...
{
    public function diff_op_delete($lines)
    {
        $this->orig = $lines;
        $this->final = false;
    }
...
{
    public function diff_op_add($lines)
    {
        $this->final = $lines;
        $this->orig = false;
    }
...
{
    public function diff_op_change($orig, $final)
    {
        $this->orig = $orig;
        $this->final = $final;
    }
...
class diff3 extends diff
{
    ...
    */
    public function diff3(&$orig, &$final1, &$final2)
    {
        $diff_engine = new diff_engine();
    ...
    */
    public function get_num_conflicts()
    {
        $conflicts = 0;
    ...
    */
    public function get_conflicts_content($label1 = 'CURRENT_FILE', $label2 = 'NEW_FILE', $label_sep = 'DIFF_SEP_EXPLAIN')
    {
        global $user;
    ...
    */
    public function merged_new_output()
    {
        $lines = array();
    ...
    */
    public function merged_orig_output()
    {
        $lines = array();
...
class diff3_op
{
    public function diff3_op($orig = false, $final1 = false, $final2 = false)
    {
...
{
    public function diff3_op_copy($lines = false)
    {
...
{
    public function diff3_block_builder()
    {
        $this->_init();
    }
