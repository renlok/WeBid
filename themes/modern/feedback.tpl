		...
		<div class="well">
			...
			<form class="form-horizontal" name="addfeedback" action="{SITEURL}feedback.php?wid={WID}&sid={SID}&ws={WS}" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<p class="form-control-static"><a href="{SITEURL}profile.php?user_id={THEM}&auction_id={AUCT_ID}">{USERNICK}</a> (<a href="{SITEURL}feedback.php?id={THEM}&faction=show">{USERFB}</a>) <img src="{SITEURL}images/icons/{USER_FB_ICON}" alt="{USER_FB_ICON}" class="fbstar"></p>
					</div>
				</div>
				<div class="form-group">
