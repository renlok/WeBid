	...
	<!-- ENDIF -->
        ...
        <!-- IF B_NLETTER -->
					<div class="form-group col-lg-12">
						...
						<label>{L_608}</label>
						<label class="checkbox-inline"><input type="radio" name="TPL_nletter" value="1" {V_YNEWSL}>
							{L_030}</label>
						<label class="checkbox-inline"><input type="radio" name="TPL_nletter" value="2" {V_NNEWSL}>
							{L_029}</label>
                                          </div>
					</div>
        <!-- ENDIF -->
