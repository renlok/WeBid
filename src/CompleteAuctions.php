...
class CompleteAuctions
{
     ...
     */
    private $endedAt = 'CURRENT_TIMESTAMP';
    ...
    /**
     * @param int $completeAuctionId
     */
    public function setCompleteAuctionId($completeAuctionId)
    {
        $this->completeAuctionId = $completeAuctionId;
    }
