...
$query[] = "INSERT INTO `" . $DBPrefix . "settings` VALUES ('maintenance_mode_active', 'bool', '0', UNIX_TIMESTAMP(), 1);";
$query[] = "INSERT INTO `" . $DBPrefix . "settings` VALUES ('maintenance_text', 'string', '<p><strong>Under maintenance!!!!!!!</strong></p>', UNIX_TIMESTAMP(), 1);";
