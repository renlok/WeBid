...
$query="SELECT id, auc_id, user_id, date, setup, featured, bold, highlighted, subtitle, relist, reserve, buynow, image, extcat, total FROM " . $DBPrefix . "useraccounts WHERE user_id = " . $user->user_data['id'] ;
