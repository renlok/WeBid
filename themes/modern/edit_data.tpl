...
<div class="row">
	...
	<div class="form-group col-lg-6">
		...
		<label>{L_352}</label>
			...
			{L_902}</label>
			<label><input type="radio" name="TPL_emailtype" value="text" {EMAILTYPE2} />
			{L_915}</label>
		</div>
	</div>
...
<!-- IF B_NEWLETTER -->
		...
		<label>{L_603}</label>
                <div class="radio">
			<label><input type="radio" name="TPL_nletter" value="1" {NLETTER1} />
			{L_030}</label>
			<label><input type="radio" name="TPL_nletter" value="2" {NLETTER2} />
			{L_029}</label>
                </div>
                        <br><div class="alert alert-info" role="alert">{L_609}</i></div>
	</div>
<!-- ENDIF -->
    </div>
</div>
