		...
		<div class="table2">
			<form name="registration" action="{SSLURL}register.php" method="post">
				<table width="90%" border="0" cellpadding="4" cellspacing=0>
					...
					<!-- IF BIRTHDATE -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_252}</b></td>
						<td width="60%">
					...
					<!-- IF ADDRESS -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_009}</b></td>
						<td width="60%">
					...
					<!-- IF CITY -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_010}</b></td>
						<td width="60%">
					...
					<!-- IF PROV -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_011}</b></td>
						<td width="60%">
					...
					<!-- IF COUNTRY -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_014}</b></td>
						<td width="60%">
					...
					<!-- IF ZIP -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_012}</b></td>
						<td width="60%">
					...
					<!-- IF TEL -->
					<tr>
						<td width="40%" valign="top" align="right"><b>{L_013}</b></td>
						<td width="60%">
